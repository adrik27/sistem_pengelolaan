                ...
                <div class="card-body">
                    ...
                    <div id="filter-form">
                        ...
                        <div class="form-filter-row">
                            ...
                            <input type="text" class="form-control date-picker" id="tanggal_awal" name="tanggal_awal"
                                placeholder="dd/mm/yyyy">
                        </div>
                        <div class="form-filter-row">
                            <label for="tanggal_akhir" class="form-label">Tanggal Akhir Hitung</label>
                            <input type="text" class="form-control date-picker" id="tanggal_akhir" name="tanggal_akhir"
                                placeholder="dd/mm/yyyy">
                        </div>
                        <div class="form-filter-row">
                            <label for="tanggal_cetak" class="form-label">Tanggal Cetak Berita Acara</label>
                            <input type="text" class="form-control date-picker" id="tanggal_cetak" name="tanggal_cetak"
                                placeholder="dd/mm/yyyy">
                        </div>
                        <div class="form-filter-row">
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            let allowShowError = false; // flag untuk mengontrol sweet alert
            ...
            const table = $('#laporan-penerimaan-table').DataTable({
                ...
                ajax: {
                    ...
                    error: function(xhr, error, code) {
                        ...
                        // SweetAlert hanya muncul jika user sudah klik filter
                        if (allowShowError) {
                            Swal.fire({
                                icon: 'error',
            ...
            $('#filter-btn').on('click', function(e) {
                e.preventDefault();
                allowShowError = true; // aktifkan error alert setelah klik filter
                table.ajax.reload();
            });
            ...
            $('#cetak-btn').on('click', function(e) {
                ...
                if (!tglAkhir || !tglCetak) {
                    Swal.fire('Input Kurang', 'Harap isi Tanggal Akhir Hitung dan Tanggal Cetak BA.',
                        'warning');
                    return;
                }

                const printUrl =
                    `{{ route('laporan.penerimaan.cetak') }}?tanggal_akhir=${tglAkhir}&tanggal_cetak=${tglCetak}&bidang_id=${bidangId}`;
