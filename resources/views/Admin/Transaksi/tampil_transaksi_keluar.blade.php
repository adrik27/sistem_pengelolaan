                    ...
                    <div class="col-12 d-flex gap-3 align-items-center">
                        ...
                        <div class="tambah-data">
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                ...
                                Tambah Transaksi Pengeluaran </button>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        <div class="hapus">
                                            <form action="{{ url('/pengeluaran/hapus/'.$item->id) }}" method="post">
                                                @csrf
                                        ...
                                        <div class="verifikasi">
                                            <form form="verifikasiForm"
                                                action="{{ url('/pengeluaran/verifikasi/'.$item->id) }}" method="post">
                                                @csrf
...
<div class="modal fade" id="update{{ $item->id }}" tabindex="-1" aria-labelledby="update{{ $item->id }}Label"
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="update{{ $item->id }}Label">Edit Data Transaksi Pengeluaran</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="formUpdate{{ $item->id }}" method="POST" action="{{ url('/pengeluaran/update/'.$item->id) }}">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12 d-flex justify-content-center gap-3">
